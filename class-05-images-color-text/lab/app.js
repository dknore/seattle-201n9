...
function sumAndMultiply(a,b,c){ //eslint-disable-line
  var add = sum(a,b)[0];
  var addAll = sum(add,c)[0];
  var times = multiply(a,b)[0];
  var timesAll = multiply(times,c)[0];
  var message = [addAll, timesAll, a + ' and ' + b + ' and ' + c + ' sum to ' + addAll + '.', 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + timesAll + '.'];
  return message;
}
...
function sumArray(testArray) { //eslint-disable-line
  ...
  var arrayTotal = sum(addFirst, testArray[2])[0];
  var message = testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' was passed in as an array of numbers, and ' + arrayTotal + ' is their sum.';
...
function multiplyArray(testArray){ //eslint-disable-line
  var timesFirst = multiply(testArray[0], testArray[1])[0];
  var arrayTotal = multiply(timesFirst, testArray[2])[0];
  var message = 'The numbers ' + testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' have a product of ' + arrayTotal + '.';
  return [arrayTotal, message];
}
